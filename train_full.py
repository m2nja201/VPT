...
def train(model, train_loader, test_loader, criterion, optimizer, total_epochs, device, lr):
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer=optimizer, T_max=total_epochs, eta_min=0.0001)
...
if __name__== '__main__':
    ...
    # model (pretrained)
    model = timm.create_model(model_name='vit_base_patch16_224', img_size=32, patch_size=4, pretrained=True, num_classes=10)
